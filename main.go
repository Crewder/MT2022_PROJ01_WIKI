...
func InitRouter() *mux.Router {
	...
	router.Methods("GET").Path("/users").Name("ViewUser").HandlerFunc(controllers.GetUsers)
	router.Methods("GET").Path("/user/{id}").Name("ViewUser").HandlerFunc(controllers.GetUser)
